...
class _SearchScreenState extends State<SearchScreen>{
        ...
        children: [
          Container(
            ...
            padding: EdgeInsets.only(left: 25.0,
                top: 25.0,right: 25.0,bottom: 20.0),
            child: Column(
              children: [
                SizedBox(height: 5.0,),
                Stack(
  ...
  void findPlace(String placeName)async{
    String autoCompleteUrl=
        "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=AIzaSyB8gHnZ83HcD5_XNtl7PCpIXvWlNuz0G50&sessiontoken=1234567890&components=country:lk";
